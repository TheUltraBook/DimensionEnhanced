...
public class TeleporterEnder extends Teleporter
{
    protected WorldServer world;

    public TeleporterEnder(WorldServer var1)
    {
        super(var1);
        this.world = var1;
    }
    ...
    public boolean placeInExistingPortal(Entity var1, double var2, double var4, double var6, float var8)
    {
        ...
        for (int var17 = var15 - var9; var17 <= var15 + var9; ++var17)
        {
            ...
            for (int var20 = var16 - var9; var20 <= var16 + var9; ++var20)
            {
                ...
                {
                    if (this.isBlockPortal(this.world, var17, var23, var20))
                    {
                        while (this.isBlockPortal(this.world, var17, var23 - 1, var20))
                        {
                            --var23;
                        }
        ...
        if (var10 >= 0.0D)
        {
            ...
            if (this.isBlockPortal(this.world, var12 - 1, var13, var14))
            {
                var28 -= 0.5D;
            }
            ...
            if (this.isBlockPortal(this.world, var12, var13, var14 - 1))
            {
                var24 -= 0.5D;
            }
    ...
    {
        return var1.getBlockId(var2, var3, var4) == BlockHandler.enderPortal.blockID;
    }

    public boolean func_85188_a(Entity var1)
    {
        double var2 = this.world.provider.dimensionId == 0 ? 2.0D : 0.5D;
        byte var4 = 16;
        double var5 = -1.0D;
        ...
        int var12 = var9;
        int var13 = 0;
        int var14 = this.world.rand.nextInt(4);
        int var15;
        double var16;
        double var19;
        int var18;
        ...
        for (var15 = var7 - var4; var15 <= var7 + var4; ++var15)
        {
            ...
            for (var18 = var9 - var4; var18 <= var9 + var4; ++var18)
            {
                ...
                {
                    if (this.world.isAirBlock(var15, var21, var18))
                    {
                        while (var21 > 0 && this.world.isAirBlock(var15, var21 - 1, var18))
                        {
                            --var21;
                        }
                            ...
                            for (var25 = 0; var25 < 3; ++var25)
                            {
                                for (var26 = 0; var26 < 4; ++var26)
                                {
                                    for (var27 = -1; var27 < 4; ++var27)
                                    {
                                        ...
                                        if (var27 < 0 && !this.world.getBlockMaterial(var28, var29, var30).isSolid() || var27 >= 0 && !this.world.isAirBlock(var28, var29, var30))
                                        {
                                            continue label178;
                                        }
                                    }
                            ...
                            for (var22 = var14; var22 < var14 + 2; ++var22)
                            {
                                ...
                                for (var25 = 0; var25 < 4; ++var25)
                                {
                                    for (var26 = -1; var26 < 4; ++var26)
                                    {
                                        ...
                                        if (var26 < 0 && !this.world.getBlockMaterial(var27, var28, var29).isSolid() || var26 >= 0 && !this.world.isAirBlock(var27, var28, var29))
                                        {
                                            continue label126;
                                        }
                                    }
        ...
        this.makePortalAt(this.world, var10, var11, var12);
        return true;
    }
    ...
    private void makePortalAt(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlock(var2 + 0, var3 + 1, var4 + 1, BlockHandler.enderPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 1, var4 + 1, BlockHandler.enderPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 2, var4 + 1, BlockHandler.enderPortal.blockID);
